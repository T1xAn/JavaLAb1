...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("kan du inte lägga en automatisk tentamen och terminsuppsats utan laboratorium?");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(CalculateButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        // TODO add your handling code here:
         ...
         double result=0;
               int n = (int)(((int)CurrentData.get(1)-(int)CurrentData.get(0))/(float)CurrentData.get(2));
                ...
                if(n*(float)CurrentData.get(2) < (int)CurrentData.get(1)){
                    float newstep = (int)CurrentData.get(1) - n*(float)CurrentData.get(2);
